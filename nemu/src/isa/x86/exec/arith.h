...
static inline def_EHelper(add) {
  ...
  rtl_set_CF(s, s0);
  rtl_is_add_overflow(s, s1, s0, ddest, dsrc1, s->width);
  rtl_set_OF(s, s1);
...
static inline def_EHelper(sub) {
  ...
  rtl_set_CF(s, s0);
  rtl_is_sub_overflow(s, s1, s0, ddest, dsrc1, s->width);
  rtl_set_OF(s, s1);
...
static inline def_EHelper(cmp) {
  ...
  rtl_set_CF(s, s1);
  rtl_is_sub_overflow(s, s2, s1, ddest, dsrc1, s->width);
  rtl_set_OF(s, s2);
...
static inline def_EHelper(inc) {
  *s0 = 1;
  ...
  rtl_set_CF(s, s1);
  rtl_is_add_overflow(s, s2, s1, ddest, s0, s->width);
  rtl_set_OF(s, s2);
...
static inline def_EHelper(dec) {
  *s0 = 1;
  ...
  rtl_set_CF(s, s1);
  rtl_is_sub_overflow(s, s2, s1, ddest, s0, s->width);
  rtl_set_OF(s, s2);
